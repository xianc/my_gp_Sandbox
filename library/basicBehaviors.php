...
<div class="wrapper">
    <p>
      ...
      <pre class="brush: js;">
        <div class="sds_grid-root">
          <div class="sds_g-1-1 sds_g-lg-1-2">
            CONTENT 1...
          </div>
          <div class="sds_g-1-1 sds_g-lg-1-2">
            CONTENT 2...
    ...
    <p>
      ...
      <pre class="brush: js;">
        <div class="sds_grid-root">
          <div class="sds_g-1-1 sds_g-lg-1-2 flexOrder2">
            CONTENT 1...
          </div>
          <div class="sds_g-1-1 sds_g-lg-1-2 flexOrder1">
            CONTENT 2...
          </div>
        </div>
      </pre>
    ...
    <p>
      Sandwich:<br>
      <div class="grid-root">
        <div class="g-1-1 g-lg-1-2 msg1 pink flexOrder2">
          <p class="padding20">CONTENT 1</p>
        </div>
        <div class="g-1-2 g-lg-1-4 msg2 green flexOrder1">
            <p class="padding20">CONTENT 2</p>
        </div>
        <div class="g-1-2 g-lg-1-4 msg3 grey flexOrder3">
      ...
      <pre class="brush: js;">
        <div class="sds_grid-root">
          ...
          <div class="sds_g-1-2 sds_g-lg-1-4 flexOrder1">
            CONTENT 2...
          </div>
          <div class="sds_g-1-2 sds_g-lg-1-4 flexOrder3">
            CONTENT 3...
          </div>
        </div>
      </pre>
